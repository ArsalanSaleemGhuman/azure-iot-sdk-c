...
TRANSPORT_LL_HANDLE IoTHubTransport_AMQP_Common_Create(const IOTHUBTRANSPORT_CONFIG* config, AMQP_GET_IO_TRANSPORT get_io_transport)
{
	...
	else
	{
		...
		{
			instance->saved_tls_options = NULL;
			instance->tls_io = NULL;
			instance->amqp_connection = NULL;
			...
			instance->http_proxy_hostname = NULL;
			instance->http_proxy_password = NULL;
			instance->http_proxy_username = NULL;
			instance->http_proxy_port = 0;
